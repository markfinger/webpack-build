...
- `buildHash`: a unique identifier generated by hashing the `buildOptions` object. Internally, the value is used
  to identify builds as they are passed between compilers, caches, and the hmr handler. This value is unrelated
  to the hash generated by webpack
