...
socket.on('connect', function () {
  return console.info('[WPW-HMR] Connected to ' + opts.root + opts.path + opts.namespace);
});

socket.on('hot', function () {
  return console.info('[WPW-HMR] Hot Module Replacement enabled');
});

socket.on('invalid', function () {
  return console.info('[WPW-HMR] Changes detected. Recompiling...');
});
...
socket.on('no-change', function () {
  return console.info('[WPW-HMR] Nothing changed');
});
