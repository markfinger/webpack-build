...
var Wrapper = (function () {
  ...
  _createClass(Wrapper, [{
      ...
      this.getConfig(function (err, config) {
        ...
        compiler.plugin('done', function (stats) {
          if (stats.hasErrors()) {
            ...
            _cache2['default'].set(_this.opts, null);
          } else {
            _cache2['default'].set(_this.opts, _this.generateOutput(stats));
          }
        });
    ...
    value: function generateOutput(stats) {
      ...
      var assets = _lodash2['default'].transform(stats.compilation.assets, function (result, obj, asset) {
      ...
      var webpackConfig = this.config || require(this.opts.config);
      ...
      if (this.opts.staticRoot && this.opts.staticUrl) {
        _lodash2['default'].forEach(data.assets, function (absPath, asset) {
