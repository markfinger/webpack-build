...
var Wrapper = (function () {
  function Wrapper(opts, config, cache) {
    ...
    this.opts = _options2['default'].generate(opts);

    this.logger = (0, _logger2['default'])('wrapper', this.opts);
  ...
  _createClass(Wrapper, [{
          ...
          compiler.plugin('done', function (stats) {
            ...
            if (stats.hasErrors()) {
              ...
              var data = {
                ...
                stats: _this.processStats(stats),
                config: _this.opts.config,
                hash: _this.opts.hash
              };

              _this.cache.set(data, _this.opts.watch);
            }
          });
        }

        if (this.opts.watch && this.opts.hmr && this.opts.hmrRoot) {
          _hmr2['default'].bindCompiler(compiler, this.opts);
        }
    ...
    key: 'processStats',
    value: function processStats(stats) {
      var _this3 = this;
      ...
      if (stats.compilation) {
        processed.pathsToAssets = _lodash2['default'].transform(stats.compilation.assets, function (result, obj, asset) {
        ...
        if (this.opts.staticRoot && this.opts.staticUrl) {
          _lodash2['default'].forEach(processed.pathsToAssets, function (absPath, asset) {
