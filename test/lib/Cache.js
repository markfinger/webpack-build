...
describe('Cache', function () {
  ...
  it('should accept a filename argument', function () {
    ...
    var cache = new _libCache2['default'](_libOptions2['default'].generate({ cacheFile: filename }));
  ...
  it('should be able to persist an entry to a file', function () {
    var cache = new _libCache2['default'](_libOptions2['default'].generate({ cacheFile: _path2['default'].join(TEST_OUTPUT_DIR, 'cache_persist.json') }));
  ...
  it('should be able to read an entry from a file', function () {
    ...
    var cache = new _libCache2['default'](_libOptions2['default'].generate({ cacheFile: filename }), true);
  ...
  describe('#get', function () {
    ...
    it('should validate a config file\'s mtime', function (done) {
      ...
      var cache1 = new _libCache2['default'](_libOptions2['default'].generate({ cacheFile: filename1 }));
      var cache2 = new _libCache2['default'](_libOptions2['default'].generate({ cacheFile: filename2 }));
